package net.runelite.client.plugins.microbot.dax.walker_engine.navigation_utils.fairyring;

import dax.walker_engine.WaitFor;
import dax.walker_engine.interaction_handling.InteractionHelper;
import dax.walker_engine.navigation_utils.fairyring.letters.FirstLetter;
import dax.walker_engine.navigation_utils.fairyring.letters.SecondLetter;
import dax.walker_engine.navigation_utils.fairyring.letters.ThirdLetter;
...
import static dax.walker_engine.navigation_utils.fairyring.letters.FirstLetter.*;
import static dax.walker_engine.navigation_utils.fairyring.letters.SecondLetter.*;
import static dax.walker_engine.navigation_utils.fairyring.letters.ThirdLetter.*;
