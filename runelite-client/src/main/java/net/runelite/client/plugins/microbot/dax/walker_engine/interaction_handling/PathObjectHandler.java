package net.runelite.client.plugins.microbot.dax.walker_engine.interaction_handling;
...
public class PathObjectHandler implements Loggable {
    ...
    private enum SpecialObject {
        ...
        HAM_JAIL("Door","Pick-lock",new RSTile(3183, 9611, 0), new SpecialCondition() {
